          ...
          <>
            ...
            <div className="mt-6 grid gap-3 sm:grid-cols-2">
              {prev && (
                <Link
                  href={`/blog/${prev.slug}`}
                  className="group rounded-2xl bg-neutral-50 px-4 py-3 transition-colors hover:bg-neutral-100 sm:text-right"
                >
              ...
              {next && (
                <Link
                  href={`/blog/${next.slug}`}
                  className="group rounded-2xl bg-neutral-50 px-4 py-3 transition-colors hover:bg-neutral-100 sm:col-start-1 sm:row-start-1"
                >
